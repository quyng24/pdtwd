  ...
  return (
    <>
      <div className="w-full flex justify-between items-center flex-wrap gap-10 py-10">
        <FadeIn direction="right" className="w-full sm:w-[48%] md:w-[30%]">
          <a href="tel:0338287804" className="flex items-center hover:mt-[-10px] duration-300 cursor-pointer">
            ...
            <div className="flex-1 pl-2">
              ...
              <p className="text-base text-black"><strong>Cô Nhàn:</strong> 0338287804</p>
            </div>
          </a>
        </FadeIn>
        ...
        <Modal title="Quét mã QR Zalo để nhận tư vấn" closable={true} open={isModalOpen} onCancel={handleCancel} footer={null}>
        ...
        <FadeIn direction="right" delay={0.4} className="w-full sm:w-[48%] md:w-[30%]">
          ...
          >
            ...
            <div className="flex-1 pl-2">
              <h3 className="text-base md:text-lg lg:text-xl font-bold text-black">Nhận tư vấn qua Messenger</h3>
              <p className="text-base text-black">Phạm Thanh Nhàn</p>
            </div>
          </a>
        </FadeIn>
