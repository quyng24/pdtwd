        ...
        <div className="w-full min-h-screen">
            ...
            <div className="w-full h-full px-10 sm:px-16 md:px-20 py-5 lg:py-10 mt-[88px]">
                ...
                <div className="mx-auto p-5 bg-white flex flex-col gap-5">
                    <h2 className="text-lg md:text-xl lg:text-2xl font-semibold">Thêm bài viết về hoạt động mới của lớp</h2>
                    {/* Title */}
                    <div className="border-b border-b-gray-200 py-3 flex flex-col items-start gap-3">
                        <label htmlFor="input-title" className="font-medium">Tiêu đề</label>
                        <Input
                            id="input-title"
                    ...
                    {/* Description */}
                    <div className="border-b border-b-gray-200 py-3 flex flex-col items-start gap-3">
                        <label htmlFor="input-description" className="font-medium">Mô tả chi tiết</label>
                        <Input.TextArea
                    ...
                    <div className="py-3 flex flex-col items-start gap-3">
                        <label htmlFor="input-uploadimg" className="font-medium">Tải lên ảnh</label>
                        <Upload
                            id="input-uploadimg"
                    ...
                    <Modal
                        ...
                        footer={[
                            <Button key="cancel" onClick={() => setPreviewOpen(false)}>Hủy</Button>,
                            <Button key="confirm" type="primary" loading={loading} onClick={handleConfirm}>Xác nhận lưu</Button>
                        ]}
                    >
