...
export default function NewsCard({ img, title, description }: CardProps) {
  ...
  return (
    <motion.article
      ...
      className="group w-full max-w-sm mx-auto overflow-hidden rounded lg:rounded-2xl border border-slate-200 bg-white/95 shadow-sm ring-1 ring-black/2 backdrop-blur-sm"
    >
